...
public class MiningSkill extends SkillBase {
    public MiningSkill(int level, float experience) {
        super(level, experience, getCurrFightingSkillLevelCap(level));
    }

    public static MiningSkill getInitializedInstance() {
        return new MiningSkill(1, 0);
    }
    ...
    private static float getCurrFightingSkillLevelCap(final int level) {
        return SkillsLevelsCapsManager.getLevelCapBySkillType(SkillType.MINING, level);
    }
}
